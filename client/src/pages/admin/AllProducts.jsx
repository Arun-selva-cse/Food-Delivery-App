            ...
            <div className="all-product-filters-body">
                ...
                <div className="all-product-filter-sort">
                    ...
                    <div className="all-product-filter-sort-body all-product-sub-filter-body">
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-sort-radio2">
                                Price (low to high)
                            </label>
                        </div>

                        <div className="form-check">
                            <input className="form-check-input" type="radio" name="flexRadioDefault" id="filter-sort-radio3" />
                            <label className="form-check-label" for="filter-sort-radio3">
                                Price (high to low)
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-sort-radio4">
                                Discount
                            </label>
                        </div>
                ...
                <div className="all-product-filter-categories">
                    ...
                    <div className="all-product-filter-categories-body all-product-sub-filter-body">
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-category-check-1">
                                Bithday Gifts
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-category-check-2">
                                Anniversary Gifts
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-category-check-3">
                                Cakes
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-category-check-4">
                                Chocolates
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" for="filter-category-check-5">
                                Flowers
                            </label>
                        </div>
                ...
                <div className="all-product-filter-gender">
                    ...
                    <div className="all-product-filter-gender-body all-product-sub-filter-body">
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="filter-gender-check-1" />
                            <label className="form-check-label" for="filter-gender-check-1">
                                Men
                            </label>
                        </div>

                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="filter-gender-check-2" />
                            <label className="form-check-label" for="filter-gender-check-2">
                                Women
                            </label>
                        </div>

                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="filter-gender-check-3" />
                            <label className="form-check-label" for="filter-gender-check-3">
                                Unisex
                            </label>
                        </div>
