            ...
            <div className="restaurant-filters-body">
                ...
                <div className="filter-sort">
                    ...
                    <div className="filter-sort-body sub-filter-body">
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="radio" name="flexRadioDefault" id="filter-sort-radio4" value="low-price" onChange={handleSortFilterChange} />
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="radio" name="flexRadioDefault" id="filter-sort-radio4" value="high-price" onChange={handleSortFilterChange} />
                            <label className="form-check-label" htmlFor="filter-sort-radio4">
                                high-price
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="radio" name="flexRadioDefault" id="filter-sort-radio4" value="rating" onChange={handleSortFilterChange} />
                            <label className="form-check-label" htmlFor="filter-sort-radio4">
                                Rating
                            </label>
                        </div>
                ...
                <div className="filter-categories">
                    ...
                    <div className="filter-categories-body sub-filter-body">
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="Veg" id="filter-category-check-1" checked={typeFilter.includes('Veg')} onChange={handleTypeCheckBox} />
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="Non Veg" id="filter-category-check-1" checked={typeFilter.includes('Non Veg')} onChange={handleTypeCheckBox} />
                            <label className="form-check-label" htmlFor="filter-category-check-1">
                                Non Veg
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="Beverages" id="filter-category-check-1" checked={typeFilter.includes('Beverages')} onChange={handleTypeCheckBox} />
                            <label className="form-check-label" htmlFor="filter-category-check-1">
                                Beverages
                            </label>
                        </div>
                    ...
                    <div className="filter-categories-body sub-filter-body">
                      ...
                      {AvailableCategories.map((category)=>(
                        <div className="form-check" key={category}>
                            <input className="form-check-input" type="checkbox" value={category} id="filter-category-check-1" checked={categoryFilter.includes(category)} onChange={handleCategoryCheckBox} />
                            <label className="form-check-label" htmlFor="filter-category-check-1">
                                {category}
                            </label>
                        </div>
